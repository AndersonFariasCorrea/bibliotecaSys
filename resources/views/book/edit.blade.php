...
<div class="mx-5">
    ...
    <form class="mt-2 text-left" action="{{ route('book.update', ['id' => $book->id]) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="form-group mt-3">
            ...
            value="{{$book['name']}}" id="name" required>
        </div>
        ...
        <div class="form-group mt-3">
            ...
            <input class="form-control" type="text" name="author_name"
                value="{{$book['author_name']}}" id="author_name"  required>
        </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="genre" id="genre"  required>
                        <option value="{{$book['genre']}}" hidden>{{ __("book.genres.{$book['genre']}") }}</option>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="register_number"
                        value="{{$book['register_number']}}" id="register_number" pattern="[A-Za-z0-9]+"  required>
                </div>
            </div>
        </div>
